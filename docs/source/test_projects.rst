...
::
    ...
    python -m <test_package> run <args>

**Note:** When no commands are provided, the ``run`` command will be executed by
default, so the following is equivalent:

::

    python -m <test_package> <args>
