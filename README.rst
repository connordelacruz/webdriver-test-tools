...
Some page object prototypes support YAML file parsing to simplify the syntax of
...
For a list of prototypes with YAML support, run ``python -m <test_package> new
page --help``. For details on YAML syntax for page objects, see the `Page Object
YAML Files documentation`_.
