...
configured. In ``page_object_tests/config/site.py``, set the ``SITE_URL`` and
...
::
    ...
    python -m page_object_tests [-h] <command>
...
::
    ...
    python -m page_object_tests --help
...
::
    ...
    python -m page_object_tests new [<type>] [<module_name>] [<ClassName>] [-d <description>] [-f]
...
::
    ...
    python -m page_object_tests new test <module_name> <TestCaseClass>
...
::
    ...
    python -m page_object_tests new test <module_name> <TestCaseClass> -d "Test case description"
...
::
    ...
    python -m page_object_tests new test <module_name> <TestCaseClass> --force
...
::
    ...
    python -m page_object_tests new page <module_name> <PageObjectClass>
...
::
    ...
    python -m page_object_tests new page <module_name> <PageObjectClass> -d "Page object description"
...
::
   ...
   python -m page_object_tests new page <module_name> <PageObjectClass> -p <prototype>

For a list of valid ``<prototype>`` options, run ``python -m page_object_tests
new page --help``.
...
::
    ...
    python -m page_object_tests new page <module_name> <PageObjectClass> --force
...
::
    ...
    python -m page_object_tests --module <test_module> [<test_module> ...]
...
::
    ...
    python -m page_object_tests --test <TestClass>[.<test_method>] [<TestClass>[.<test_method>] ...]

To skip certain test cases or methods, use the ``--skip`` (or ``-s``) argument:

::

    python -m page_object_tests --skip <TestClass>[.<test_method>] [<TestClass>[.<test_method>] ...]
...
::
    ...
    python -m page_object_tests <args> --browser <browser> [<browser ...]

For a list of options you can specify with ``--browser``, run ``python -m
page_object_tests --help``.
...
::
    ...
    python -m page_object_tests <args> --headless
...
::
    ...
    python -m page_object_tests <args> --browserstack
...
::
    ...
    python -m page_object_tests <args> --verbosity <level>
...
``page_object_tests/config/test.py`` by setting the ``DEFAULT_VERBOSITY``
...
::
    ...
    python -m page_object_tests list

To only list test classes from specific modules:

::

    python -m page_object_tests list --module <test_module> [<test_module> ...]

To only list specific test classes:

::

    python -m page_object_tests list --test <TestClass> [<TestClass> ...]
...
.. |webdriver_test_tools| image:: https://img.shields.io/badge/generated%20using-webdriver__test__tools%202.6.0-blue.svg?style=for-the-badge
    :alt: webdriver_test_tools 2.6.0
